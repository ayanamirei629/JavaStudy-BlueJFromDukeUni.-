...
public class FirstRatings {
    ...
    public void testLoadRaters(){
        ArrayList<Rater> rates = loadRaters("ratings.csv");
        System.out.println("There are " + rates.size() + " ratings.");
        ArrayList<String> al = new ArrayList<String>();
        String IDrates = "";
        String IDItem = "";
        Rater IDRater = new Rater("2");
        double maxR = 0;
        int count = 0;
        int maxRBR = 0;
        String maxS = "";
